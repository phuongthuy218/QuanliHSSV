      ...
      public static DataTable Getlistlophoc()
        ...
        public static int InsertProfile(hocba hb)
        {
            SqlParameter[] para = new SqlParameter[]
            {
                 ...
                 new SqlParameter("@dg",hb.danhgiagv),
        ...
        public static int UpdateProfile(hocba hb)
        {
            ...
            return DataProvider.ExecuteNonQuery("SuaThongTinHocBa", para);
        }
        ...
        {
            return DataProvider.GetData("select*from bangluong");
        }
        public static int InsertProfile(bangluong bl)
        {
            SqlParameter[] para = new SqlParameter[]
            {
                 new SqlParameter("@ma",bl.magv),
                 new SqlParameter("@lcb", bl.luongcoban),
                 new SqlParameter("@hsl",bl.hesoluong),
                 new SqlParameter("@lpc",bl.luongphucap),
                 new SqlParameter("@bhyt",bl.BaoHiemYTe),
                 new SqlParameter("@tl" , bl.TongLuong)

            };
            return DataProvider.ExecuteNonQuery("themluong", para);
        }
        public static int UpdateProfile(bangluong bl)
        {
            ...
            return DataProvider.ExecuteNonQuery("sualuong", para);
        }
        internal static int DeleteProfile(bangluong bl)
        {
            SqlParameter[] para = new SqlParameter[]
            {
              new SqlParameter ("@ma",bl.magv),
        };
            return DataProvider.ExecuteNonQuery("xoabangluong", para);
        }
        /////// kỷ luật
        ...
        public static int InsertProfile(kyluat kl)
        {
            SqlParameter[] para = new SqlParameter[]
            {
                 new SqlParameter("@mahs",kl.mahs),
                 new SqlParameter("@ht",kl.hinhthuc),
                 new SqlParameter("@ld",kl.lydo),
                 new SqlParameter("@nkl",kl.ngaykyluat),
                new SqlParameter("@ghichu",kl.ghichu)
            };
            return DataProvider.ExecuteNonQuery("themkyluat", para);
        }
        public static int UpdateProfile(kyluat kl)
        {
            ...
            return DataProvider.ExecuteNonQuery("suakyluat", para);
        }
        internal static int DeleteProfile(kyluat kl)
        {
            SqlParameter[] para = new SqlParameter[]
            {
              new SqlParameter ("@ma",kl.mahs),
        };
            return DataProvider.ExecuteNonQuery("xoakyluat", para);
        }
        /// khen thưởng
        ...
        public static int InsertProfile(khenthuong kt)
        {
            SqlParameter[] para = new SqlParameter[]
            {
                 new SqlParameter("@mahs",kt.mahs),
                 new SqlParameter("@ht",kt.hinhthuc),
                 new SqlParameter("@ld",kt.lydo),
                 new SqlParameter("@nk",kt.ngaykhenthuong)
            };
            return DataProvider.ExecuteNonQuery("themkhenthuong", para);
        }
        public static int UpdateProfile(khenthuong kt)
        {
            ...
            return DataProvider.ExecuteNonQuery("suakhenthuong", para);
        }
        internal static int DeleteProfile(khenthuong kt)
        {
            SqlParameter[] para = new SqlParameter[]
            {
              new SqlParameter ("@ma",kt.mahs),
        };
            return DataProvider.ExecuteNonQuery("xoakhenthuong", para);
        }
    }
}
